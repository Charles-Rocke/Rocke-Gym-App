...
function selectWorkouts(data, specifiedSubcategory) {
...
const specifiedSubcategory = "shoulders.lateral";
const exercises = selectWorkouts(strength, specifiedSubcategory);
